...
const ArticleSettings = ({dropDown, accordion, children, label, dropDownData, name, setFormData, formData, dropDownName, subOf=''}: {dropDown?: boolean; accordion?: boolean; children?: React.ReactNode; label: string; dropDownData?: string[], name: string; setFormData: (data: any) => void; formData: any; dropDownName?: string; subOf?: string}) => {
  ...
  return (
    <>
        <article className={styles['dmrSection__settings']}>
            ...
            <ToggleSwitch onToggle={(value: boolean) => setExpand(prev => !prev)} name={name} setFormData={setFormData} formData={formData} subOf={subOf}/>
